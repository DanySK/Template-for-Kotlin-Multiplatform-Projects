...
class MajorityVotesAndHighestScoreAlgorithm<S : ScoreMetrics>(override val pollAlgorithmParameters: List<PollAlgorithmParameter> = listOf()) : PollAlgorithm<S, SinglePreferenceVote<S>> {
